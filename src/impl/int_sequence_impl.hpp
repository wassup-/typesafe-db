...
namespace fp {
    ...
    namespace impl {
        ...
        template<int V, int H, int... T> struct is_contained_int_impl<V, H, T...> : is_contained_int_impl<V, T...> {
        };
        ...
        template<int I, int V, int H, int... T> struct index_of_impl<I, V, H, T...> : index_of_impl < I + 1, V, T...> {
        };
        ...
        template<int C, int V, int H, int... T> struct occurences_of_impl<C, V, H, T...> : occurences_of_impl<C, V, T...> {
        };
