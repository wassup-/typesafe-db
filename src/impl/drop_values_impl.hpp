...
namespace fp {
    ...
    namespace impl {
        ...
        template<int C, bool S, int... L, int... R> struct drop_values_impl<C, S, int_seq<L...>, int_seq<R...> > : drop_values_impl<C, (C == sizeof...(R) - 1), int_seq < L..., fp::first_value_of < R...>::value>, typename fp::skip_value < R...>::type > {
        };
