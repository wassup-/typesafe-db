...
namespace fp {
    ...
    struct insertion_sort<int_seq<S...>, int_seq<L...>, int_seq<R...> > {
    ...
    struct insertion_sort<int_seq<S...>, int_seq<L...>, int_seq<> > : insertion_sort < int_seq < S..., L...>, int_seq<>, int_seq<> > {
    };

    template<int... S, int... R>
    struct insertion_sort<int_seq<S...>, int_seq<>, int_seq<R...> > : insertion_sort < int_seq < S..., R...>, int_seq<>, int_seq<> > {
    };

    template<int... S>
    struct insertion_sort<int_seq<S...>, int_seq<>, int_seq<> > {
