...
namespace fp {
	...
	template<typename C, typename T, typename A> struct container_traits<std::basic_string<C, T, A> > {
		typedef vectorlike_tag category;
	};
	...
	template<typename K, typename H, typename P, typename A> struct container_traits<std::unordered_set<K, H, P, A> > {
		typedef associative_tag category;	
	};
	...
	template<typename K, typename H, typename P, typename A> struct container_traits<std::unordered_multiset<K, H, P, A> > {
		typedef associative_tag category;	
	};
	...
	template<typename K, typename T, typename H, typename P, typename A> struct container_traits<std::unordered_map<K, T, H, P, A> > {
		typedef associative_tag category;
	};

	template<typename K, typename T, typename C, typename A> struct container_traits<std::multimap<K, T, C, A> > {
		typedef associative_tag category;	
	};

	template<typename K, typename T, typename H, typename P, typename A> struct container_traits<std::unordered_multimap<K, T, H, P, A> > {
		typedef associative_tag category;
	};
}
