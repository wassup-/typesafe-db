...
#if !FP_HAS_FEATURE(CXX_ALIGNED_UNION)
...
#endif // !FP_HAS_FEATURE(CXX_ALIGNED_UNION)
...
namespace fp {
    ...
    namespace std {
        ...
        struct aligned_union
        : ::std::aligned_storage<
              ::fp::max< ::std::integral_constant<decltype(sizeof(0)), Len>, ::std::integral_constant<decltype(sizeof(0)), sizeof(T)>...>::value,
              ::fp::max< ::std::integral_constant<decltype(sizeof(0)), alignof(T)>...>::value> {
            static constexpr size_t alignment_value = alignof(::fp::Invoke<aligned_union>);
        };
    } // namespace std
    #define FP_HAS_FEATURE_CXX_ALIGNED_UNION
