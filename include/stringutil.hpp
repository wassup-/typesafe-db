...
template<typename>
struct is_char_type : meta::bool_<false> { };
template<typename T>
struct is_char_type<const T> : is_char_type<T> { };
template<>
struct is_char_type<char> : meta::bool_<true> { };
template<>
struct is_char_type<wchar_t> : meta::bool_<true> { };
template<>
struct is_char_type<char16_t> : meta::bool_<true> { };
template<>
struct is_char_type<char32_t> : meta::bool_<true> { };

template<typename>
struct is_std_string : meta::bool_<false> { };
template<typename T>
struct is_std_string<const T> : is_std_string<T> { };
template<typename CharT, typename Traits, typename Alloc>
struct is_std_string<std::basic_string<CharT, Traits, Alloc> > : meta::bool_<true> { };

template<typename T>
struct is_string_like : meta::if_<
							is_std_string<T>,
							meta::bool_<true>,
							is_char_type<
